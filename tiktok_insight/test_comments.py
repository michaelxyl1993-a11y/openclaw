...
def main():
    ...
    if items and isinstance(items[0], dict):
        if items[0].get("errorCode") or items[0].get("error"):
            ...
            raise RuntimeError("Apify returned an error item. Please check the TikTok URL.")
